...
batch_size = 36 # if you used to fine-tune normal ViT-L/14 with batch size 48, then 40 may be a good start. GmP needs slightly more VRAM.

# Define your training dataset(s) and dataloader
dataset1 = ImageTextDataset("path/to/images/", "path/to/train-labels.json", transform=preprocess)
...
val_dataset = ImageTextDataset("path/to/images/", "path/to/val-labels.json", transform=preprocess)
