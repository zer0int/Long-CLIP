...
batchsize = 16
many_tokens = 8     # How many tokens to sample. Don't use too many -> will become meaningless "random grab" of closeby tokens.

device = 'cuda'

# longclip-B.pt - longclip-L.pt"
...
print(Fore.YELLOW + "\nDone. Check the 'TOK' folder for results!")