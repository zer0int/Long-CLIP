...
path_to_checkpoint = 'checkpoints/longclip-L.pt'
device = "cuda:0" if torch.cuda.is_available() else "cpu"
model, preprocess = longclip.load(path_to_checkpoint, device=device)
...
# learning_rate: Typically 1e-6 to 1e-7. I find 1e-5 to always result in overfit with such a small batch size.
